		...
		<?php if($entry_format_meta_blog != 'hide-meta' ){ ?>
			<div class="entry-meta">
				...
				if ( comments_open() && $cocktail_post_comments !=1) { ?>
						<span class="comments">
						<?php comments_popup_link( __( '<i class="fa-regular fa-comment"></i> No Comments', 'cocktail' ), __( '<i class="fa-regular fa-comment"></i> 1 Comment', 'cocktail' ), __( '<i class="fa-regular fa-comment"></i> % Comments', 'cocktail' ), '', __( 'Comments Off', 'cocktail' ) ); ?> </span>
				<?php } ?>
			</div> <!-- end .entry-meta -->
		<?php } ?>
