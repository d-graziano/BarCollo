				...
				<div class="wrap">
					...
					<?php
					 ...
					 if ( is_active_sidebar( 'cocktail_footer_options' ) ) :
						...
						<!-- Domenico - INIZIO -->
						<?php echo esc_html__('Non si tratta di attività commerciale o a scopo di lucro e niente di quanto illustrato è in vendita. Questo sito internet è stato creato esclusivamente a scopo goliardico in modo ironico, esso rappresenta un angolo bar casalingo privato che si condivide con familiari e amici. ','cocktail'); ?>
						<!-- Domenico - FINE -->
