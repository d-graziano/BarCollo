							...
							<header class="feature-post-entry-header">
								...
								<div class="entry-meta">
									...
									if ( comments_open() && $cocktail_post_comments !=1) { ?>
											<span class="comments">
											<?php comments_popup_link( __( '<i class="fa-regular fa-comment"></i> No Comments', 'cocktail' ), __( '<i class="fa fa-comments-o"></i> 1 Comment', 'cocktail' ), __( '<i class="fa fa-comments-o"></i> % Comments', 'cocktail' ), '', __( 'Comments Off', 'cocktail' ) ); ?> </span>
									<?php } ?>
								</div> <!-- end .entry-meta -->
